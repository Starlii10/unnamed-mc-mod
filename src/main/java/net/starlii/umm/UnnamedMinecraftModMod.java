...
@Mod("unnamed_minecraft_mod")
public class UnnamedMinecraftModMod {
	public static final Logger LOGGER = LogManager.getLogger(UnnamedMinecraftModMod.class);
	public static final String MODID = "unnamed_minecraft_mod";
